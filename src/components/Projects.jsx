    ...
    <div className="flex flex-col px-6 mb-7">
      ...
      {projects.length > collection.length ? (
        <div className="flex justify-center items-center my-5">
          <button
            type="button"
            className="inline-block px-6 py-2.5 bg-cyan-300
          text-white font-medium text-xs leading-tight uppercase
          rounded-full shadow-md hover:bg-cyan-600"
      ...
      <Link to={'/projects/' + project.id}>
        ...
        <div className="p-4">
          ...
          <div className="w-full bg-gray-300 overflow-hidden">
            <div
              className="bg-cyan-600 text-xs font-medium
            text-cyan-100 text-center p-0.5 leading-none
            rounded-l-full"
          ...
          >
            ...
            <div>
              {expired ? (
                ...
                <small className="text-cyan-500">Accepted</small>
              ) : project?.status == 2 ? (
